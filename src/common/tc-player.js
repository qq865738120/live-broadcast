...
function(e, t) {
	...
	return function(e) {
		...
		], _ = E[0], T = void 0, D = 0; D < E.length; D++) E[D][1] in document && (T = E[D]);
		...
		function(e) {
			...
			return a(t, e), t.prototype.render = function(t) {
				...
				if (!g.IS_ENABLED_MSE || !i && !o || g.IS_X5TBS && this.player.options.x5_player || i && g.IS_MAC && g.IS_SAFARI && !g.IS_IOS) this.__type = t, this.el.src = e;
					...
					}) : this.__hlsLoaded(e)) : o && (this.__type = f.VideoType.FLV, "undefined" == typeof window.flvjs ? h.loadScript(f.unifyProtocol(f.CDNPath + "libs/flv.min.js"), function() {
